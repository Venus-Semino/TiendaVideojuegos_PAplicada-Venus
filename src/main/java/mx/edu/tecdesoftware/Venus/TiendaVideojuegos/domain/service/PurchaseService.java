...
public class PurchaseService {
    ...
    public Optional<Purchase> getPurchase(Integer purchaseId) { return purchaseRepository.getPurchase(purchaseId); }

    public Optional<List<Purchase>> getByClient(Integer clientId) { return purchaseRepository.getByClient(clientId); }
